...
def DiT_3B_2(**kwargs):
    return DiT(depth=32, hidden_size=2400, patch_size=2, num_heads=24, **kwargs)

def DiT_7B_2(**kwargs):
    return DiT(depth=32, hidden_size=3520, patch_size=2, num_heads=32, **kwargs)
...
DiT_models = {
    ...
    'DiT-3B/2': DiT_3B_2,  'DiT-7B/2': DiT_7B_2,
}
